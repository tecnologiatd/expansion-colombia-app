...
const FormField = ({
  ...
  return (
    <View className="space-y-2 mt-7">
      <Text className="text-white text-base font-medium mb-3">{title}</Text>
      <View className="border-black-200 h-16 relative">
        <TextInput
          className="flex-1 w-full p-4 text-base font-semibold border-white text-white focus:border-secondary  active:border-secondary border-2 rounded-2xl"
          value={value}
